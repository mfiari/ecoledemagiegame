        ...
        this.menu.ajouterEcouteur(new PropertyChangeListener() {
            ...
            public void propertyChange(PropertyChangeEvent evt) {
                if (evt.getPropertyName().equals("actualiseLangue")) {
                    ...
                    if (evt.getPropertyName().equals("afficherMenu")) {
                        afficherMenu();
                    } else if (evt.getPropertyName().equals("configuration")) {
                        configuration();
                    } else if (evt.getPropertyName().equals("choixLangue")) {
                        choixLangue();
                    }
                    attendre();
                }
