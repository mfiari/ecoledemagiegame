...
import mfiari.ecoledemagie.game.texte.TexteVueMenuReseau;
...
public class VueSwing_menuReseau extends VueSwing {
    ...
    private void choixClientServeur() {
        ...
        boutonServeur.addActionListener(new boutonChoix(1));
        JButton boutonClient = new JButton("rejoindre une partie");
        boutonClient.addActionListener(new boutonChoix(2));
        JButton boutonRetour=new JButton(this.textes.retour);
        boutonRetour.addActionListener(new boutonChoix(0));
